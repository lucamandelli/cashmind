...
status: current
updated: 2026-06-10
summary: Sub-hub for known bugs and gotchas — date shift, Better Auth account collision, Fastify body stream, Better Auth tables stay on TIMESTAMP(3) by design.
tags: [log, moc]
---
...
- [[0004-better-auth-tables-timestamp3]] — Better Auth tables stay on `TIMESTAMP(3)` by design; do not migrate them
